...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('jpedro1000@gmail.com')
    setCopied(true)
  }
    ...
    >
      <div className={cn(id === 6 && 'flex justify-center', 'h-full')}>
        ...
        <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col p-5 lg:p-10')}>
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 2-fit absolute -right-3 lg:-right-2">
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              <div className="absolute -bottom-5 right-0">
                <Lottie options={{
                  loop: copied, autoplay: copied, animationData, rendererSettings: {
